...
class KITTITracking(GenericDataset):
  ...
  #       'Tram', 'Misc', 'DontCare']
  cat_ids = {1:1, 2:2, 3:-9999, 4:-9999, 5:-9999, 6:-9999, 7:-9999, 8:-9999, 9:-9999}
  max_objs = 100
  def __init__(self, opt, split):
    ...
    #    ann_file_))
    img_dir = '/home/zhe.zhao/data/kitti_track/training/image_02/'
    ann_path = '/home/zhe.zhao/data/kitti_track/annotations/tracking_train.json'
